...
const polyhendronGeometry = new THREE.IcosahedronGeometry(8,0);
const polyhendronMaterial = new THREE.MeshStandardMaterial({
    map: textureLoader.load('./images/2.jpg'),
    metalness: 0.2,
    roughness: 0.07
});
const polyhedron = new THREE.Mesh(polyhendronGeometry,polyhendronMaterial);
polyhedron.castShadow = true;
polyhedron.position.x = 20;
polyhedron.position.y = 10;
//polyhedron.scale.y = 2; 
scene.add(polyhedron);

//Circulito
const spheraGeometry = new THREE.SphereGeometry(5,20,20);
